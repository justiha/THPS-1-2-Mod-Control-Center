...
Interactive Menu Interface: Displays your current active working directory, selected Unreal Engine version, and live 
game installation path at the top of the terminal screen in real-time.
